...
Na conferência Agile 2008, Mary Poppendieck conduziu um
\emph{workshop}\footnote{\url{http://submissions.agile2008.org/node/376} -
...
Os doze princípios enumerados são um pouco maiores mas também são mais
...
\footnote{\url{http://launchpad.net/} - Último acesso 24/04/2009}, o projeto
...
envolvidas no projeto, separação física e sua diversidade de conhecimentos e
...
Como Beck sugere \cite{Beck2008}, ferramentas podem melhorar a adoção e
o uso de práticas ágeis e, dessa forma, melhorar o processo de
...
distribuída\footnote{http://sf.net/projects/xpairtise/ - Último
  acesso: 02/10/2008}$^{,}$
\footnote{https://www.inf.fu-berlin.de/w/SE/DPP - Último acesso: 26/09/2009}$^{,}$
\footnote{http://sangam.sourceforge.net/ - Último acesso: 26/09/2009}
 e estudos a respeito \cite{Nagappan2003} mas
...
tempo e se baseia em fatos que podem mudar com o tempo (tal como ``essa
...
pretende fazer a seguir. Essa prática compartilha dos mesmos
...
sugestão é que a comunicação que acontece nesses canais IRC seja
salva e exibida aos usuários que acabam de se conectar. Também
