...
confiança, amor e apoio. À Mariana Bravo pelo apoio, companhia, revisões e ajudas
...
discussões. 
Aos irmãos Freire pela sociedade, oportunidades, longas discussões e
...
diversão, alegria e felicidade.
Aos outros membros da AgilCoop pelas experiências, ideias,
conversas e ajudas.
...
A relação entre métodos ágeis e software livre é indefinida. A
...
ambientes. Também decorre uma análise de métodos ágeis, em especial,
Programação Extrema, do ponto de vista de um modelo de maturidade para
ambientes de software livre, o Modelo de Maturidade Aberto (OMM) do
projeto QualiPSo.

\noindent \textbf{Palavras-chave:} métodos ágeis, open source,
software livre, omm, xp
...
undefined. At first glance, the two communities do not seem to have
