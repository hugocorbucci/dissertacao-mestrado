...
cumprida com a realizaçao do planejamento da iteração e a coleta de
...
manutenção de testes em vários nível (Testes de unidade, de integração
...
realizado de forma simples e direto. A forma de contribuir com
...
garantir que o código da aplicação mantém-se legível e mais simples de
...
possível garantir também que o sistema se comporta como esperado em
...
conjunto de histórias que preenche o Ciclo Semanal.
...
\subsection{Elementos essenciais não cobertos pela Programação Extrema}
\label{sec:xp-omm}
...
ela é priorizada e incluída no Ciclo Semanal como qualquer outra
funcionalidade. Sendo assim, o processo não garante que a documentação
para o usuário será desenvolvida mas garante que, se ela for
importante, ela será realizada.
