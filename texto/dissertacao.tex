...
% Este trabalho contou com o apoio do projeto Qualipso
% \cite{Qualipso}.
...
least, undefined. At first glace, the two communities do not seem to
...
\input cap-similarities % associado ao arquivo: 'cap-similarities.tex'
\input cap-differences % associado ao arquivo: 'cap-differences.tex'
