...
O Freshmeat.net\footnote{\url{http://freshmeat.net} -- Último acesso em
...
listados e a quantidade de projetos com, pelo menos, 2
...
que levaram a ela. Essa mudança não pode ser enviada ao galho
principal do repositório a não ser que o revisor externo a aprove. O
revisor externo não deve ser uma única pessoa mas um papel que circula
entre vários usuários da plataforma. Essa prática é conhecida como
revisão cruzada das mudanças de API ou, simplesmente, uma revisão
cruzada.
